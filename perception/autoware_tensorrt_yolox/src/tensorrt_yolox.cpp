...
TrtYoloX::TrtYoloX(
  ...
  const bool use_gpu_preprocess, const int gpu_id, std::string calibration_image_list_path, const double norm_factor,
...
{
  gpu_id_ = gpu_id;
  std::cout << "Selected GPU ID:: " << gpu_id << std::endl;
